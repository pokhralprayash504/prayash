...
const Category = () => {
  return (
    <div
      className="grid grid-cols-1  sm:grid-cols-4 px-12 gap-10
    "
    >
      {data.map((i, id) => (
        <div
          className={`bg-blue-200 p-6 rounded-3xl h-75 relative  ${id === data.length - 1 ? "col-span-2" : ""} `}
        >
          <div className="flex flex-col items-start">
            <h1 className="text-gray-100">{i.title}</h1>
            <h1 className="text-2xl font-semibold text-white">{i.title2}</h1>
